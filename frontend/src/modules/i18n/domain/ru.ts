export const ru = {
	...
	admin: {
		...
		equipment: {
			...
			emptyActive: 'Активное оборудование не найдено',
			emptyInactive: 'Неактивное оборудование не найдено',
			icons: {
				video: 'Видео',
		...
		roomTypes: {
			...
			subtitle: 'Управление кодами типов аудиторий и переводами.',
			loading: 'Загрузка типов аудиторий...',
			emptyActive: 'Активные типы не найдены',
			emptyInactive: 'Неактивные типы не найдены',
			active: 'Активно',
			inactive: 'Неактивно',
			tabs: {
				active: 'Активные',
			...
			form: {
				createTitle: 'Новый тип аудитории',
				editTitle: 'Изменить тип аудитории',
				code: 'Код',
				labelRu: 'Название на русском',
				labelEn: 'Название на английском',
				sortOrder: 'Сорт.',
			...
			alerts: {
				deleteTitle: 'Удалить тип аудитории навсегда',
				deleteDesc:
					'Удалить тип {code}? Действие необратимо. Все аудитории этого типа и связанные бронирования пользователей тоже будут удалены.',
				deleteCancel: 'Оставить',
				deleteConfirm: 'Удалить',
				deleting: 'Удаление...',
			},
			toasts: {
				deactivated: 'Тип аудитории перемещён в неактивные',
				reactivated: 'Тип аудитории восстановлен',
				deleted: 'Тип аудитории удалён',
				deleteFailed: 'Не удалось удалить тип аудитории',
			},
		},
		buildings: {
			title: 'Здания',
			subtitle: 'Управление кодами зданий и переводами для фильтров и аудиторий.',
			loading: 'Загрузка зданий...',
			emptyActive: 'Активные здания не найдены',
			emptyInactive: 'Неактивные здания не найдены',
			active: 'Активно',
			inactive: 'Неактивно',
			tabs: {
				active: 'Активные',
			...
			alerts: {
				deleteTitle: 'Удалить здание навсегда',
				deleteDesc:
					'Удалить здание {code}? Действие необратимо. Все аудитории в этом здании и связанные бронирования пользователей тоже будут удалены.',
				deleteCancel: 'Оставить',
				deleteConfirm: 'Удалить',
				deleting: 'Удаление...',
			},
			toasts: {
				deactivated: 'Здание перемещено в неактивные',
				reactivated: 'Здание восстановлено',
				deleted: 'Здание удалено',
				deleteFailed: 'Не удалось удалить здание',
			},
		},
		purposes: {
	...
	validation: {
		...
		invalidCode: 'Код должен содержать латинские строчные буквы, цифры, _ или -',
